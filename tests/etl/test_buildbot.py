    ...
    ('release-mozilla-beta-firefox_updates',
     {'build_type': 'opt',
      ...
      'platform': {'arch': '-',
                   'os': '-',
                   'os_platform': 'all'}}),
    ('release-mozilla-beta_firefox_bncr_sub',
     {'build_type': 'opt',
      'job_type': 'build',
      'name': {'group_name': 'Release Promotion',
               'group_symbol': 'RP',
               'name': 'Bouncer Submission',
               'job_symbol': 'BSub'},
      'platform': {'arch': '-',
                   'os': '-',
                   'os_platform': 'all'}}),
    ('release-mozilla-beta-firefox_chcksms',
     {'build_type': 'opt',
      'job_type': 'build',
      'name': {'group_name': 'Release Promotion',
               'group_symbol': 'RP',
      ...
      'platform': {'arch': '-',
                   'os': '-',
                   'os_platform': 'all'}}),
    ('release-mozilla-beta-firefox_uptake_monitoring',
     {'build_type': 'opt',
      'job_type': 'build',
      'name': {'group_name': 'Release Promotion',
               'group_symbol': 'RP',
               'name': 'Uptake Monitoring',
               'job_symbol': 'up-m'},
      'platform': {'arch': '-',
                   'os': '-',
                   'os_platform': 'all'}}),
    ('release-mozilla-beta-firefox_bouncer_aliases',
     {'build_type': 'opt',
      'job_type': 'build',
      'name': {'group_name': 'Release Promotion',
               'group_symbol': 'RP',
               'name': 'Bouncer Aliases',
               'job_symbol': 'BA'},
      'platform': {'arch': '-',
                   'os': '-',
                   'os_platform': 'all'}}),
    ('release-mozilla-beta-firefox_version_bump',
     {'build_type': 'opt',
      'job_type': 'build',
      'name': {'group_name': 'Release Promotion',
               'group_symbol': 'RP',
